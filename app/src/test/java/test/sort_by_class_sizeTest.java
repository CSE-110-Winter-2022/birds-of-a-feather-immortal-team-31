...
public class sort_by_class_sizeTest {
    ...
    public void setUp(){
        ...
        User user2 = new User("Zoro","", User.coursesToString(new ArrayList<Course>()), 200879, false, false, 7);
        User user3 = new User("Nami","", User.coursesToString(new ArrayList<Course>()), 226542, false, false, 8);
