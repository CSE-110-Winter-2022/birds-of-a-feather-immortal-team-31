...
public class MainActivity extends AppCompatActivity implements GoogleApiClient.OnConnectionFailedListener, AdapterView.OnItemSelectedListener {
    ...
    protected Course demo1 = new Course(2020, "spring", "CSE110");
    protected Course demo2 = new Course(2077, "winter", "CSE101");
    protected Course demo3 = new Course(2020, "fall", "CSE2");
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Course demo1 = new Course(2021, "fall", "cse110");
