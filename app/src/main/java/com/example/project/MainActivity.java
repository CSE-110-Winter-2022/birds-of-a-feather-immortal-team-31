...
public class MainActivity extends AppCompatActivity implements GoogleApiClient.OnConnectionFailedListener, AdapterView.OnItemSelectedListener {
    ...
    public User user1 = new User("Luffy","",new ArrayList<Course>(), 179870, false, 4);
    ...
    public User jon = new User("Jon", "", new ArrayList<Course>(), 824586, false, 3);
    ...
    public void onSearchForClassmatesClicked(View view) {
        ...
        if (text.equals("Start")) {
            ...
            //this.messageListener = new FakedMessageListener(messageListener, 1, fakedMessageString);
        ...
        public void onFound(@NonNull Message message) {
            ...
            if (sMessage.substring(0, 5).equals("B3%&J")) { //authentication key of message
                ...
                if (!fellowStudentMutualCourse.isEmpty()) {
                    Log.d("in first if", "v");
                    User noWaveUser = new User(fellowStudentName, fellowStudentPhotoURL, fellowStudentMutualCourse, Integer.parseInt(fellowStudentID), false, fellowStudentNoCourses);
                    if (waved) fellowStudentName += new String(Character.toChars(0x1F44B));
                    User user = new User(fellowStudentName, fellowStudentPhotoURL, fellowStudentMutualCourse, Integer.parseInt(fellowStudentID), waved, fellowStudentNoCourses);
